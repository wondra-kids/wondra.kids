import{r as E,j as t}from"./index-1bhqG9Xr.js";import{W as Qe,h as He,e as Ot,a as Be,r as Ht,b as Et,n as Qt,w as _t,c as Fe,p as Vt,d as At,f as qt,l as Ut,g as Dt,i as It,X as Xt,u as Wt}from"./storage-BQMorl-n.js";function Bt(e,n){return e==="unknown_command"||e==="step_failed"?"failure":e==="already_complete"||n?"success":"no-effect"}function Ft(e,n,r){const l=[];let d=n;const k=v=>({outcome:Bt(v,e.isComplete(d)),reason:v,steps:l,finalState:d});if(r.length===0)return k("empty");if(e.isComplete(d))return k("already_complete");for(const v of r){const f=e.commands[v];if(f===void 0)return k("unknown_command");for(const m of f){try{d=m.apply(d)}catch{return k("step_failed")}l.push({index:l.length,event:m.event,commandId:v,state:d})}}return k("executed")}function Ge(e){return{sceneId:e.id,obstacleOpen:!1,beaconOn:!1,bellCount:0,olaWaved:!1,roka:{...e.positions.roka},phase:"ready",lastCommand:null}}function J(e,n){return n.sceneId===e.id&&n.obstacleOpen&&n.roka.x===e.positions.goal.x&&n.roka.y===e.positions.goal.y}function xe(e,n){const r=J(e,n),l=[];return n.obstacleOpen&&l.push(e.kind==="bridge"?"bridge_opened":"door_opened"),r&&l.push(e.kind==="bridge"?"bridge_crossed":"transfer_success"),{success:r,criteriaValidated:l}}function Y(e,n,r){return{event:n,apply:l=>({...l,lastCommand:e,...r(l)})}}function Gt(e){const n={},r=d=>e.commands.some(k=>k.id===d),l=e.openCommand;return r(l)&&(n[l]=[Y(l,"opened",()=>({phase:"opening",obstacleOpen:!0})),Y(l,"crossed",()=>({phase:"crossing",roka:{...e.positions.goal}})),Y(l,"completed",()=>({phase:"complete"}))]),r("sonner")&&(n.sonner=[Y("sonner","rang",d=>({phase:"reacting",bellCount:d.bellCount+1,olaWaved:!0})),Y("sonner","settled",()=>({phase:"ready"}))]),r("allumer")&&(n.allumer=[Y("allumer","lit",()=>({phase:"reacting",beaconOn:!0})),Y("allumer","settled",()=>({phase:"ready"}))]),{commands:n,isComplete:d=>J(e,d)}}function Ze(e,n,r){if(n.sceneId!==e.id)throw new Error("La scène et l’état ne correspondent pas.");const l=k=>({reason:k,steps:[],finalState:n,verdict:xe(e,n)});if(!Array.isArray(r)||r.length>1)return l("invalid_program");const d=Ft(Gt(e),n,r);return{reason:d.reason,steps:d.steps,finalState:d.finalState,verdict:xe(e,d.finalState)}}const ze=e=>String(e).replace(/[&<>"']/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[n]??n);function ke(e,n,r,l){if(typeof e!="number"||!Number.isFinite(e)||e<r||e>l)throw new TypeError(`Coordonnée invalide : ${n}`);return e}function be(e,n){const r=e??{};return{x:ke(r.x,`${n}.x`,0,760),y:ke(r.y,`${n}.y`,0,340)}}function Je(e){if(e===null||typeof e!="object"||!["bridge","door"].includes(e.kind))throw new TypeError("Type de scène invalide.");const n=e.positions??{},r=v=>be(n[v],`positions.${v}`),l=r("obstacle"),d=ke((n.obstacle??{}).width,"positions.obstacle.width",14,300),k={x:l.x,y:l.y,width:d};if(k.x+k.width>760)throw new TypeError("Obstacle hors de la scène.");return e.kind==="door"&&ke(k.y,"positions.obstacle.y (porte)",114,277),{roka:r("roka"),goal:r("goal"),ola:r("ola"),obstacle:k,beacon:r("beacon"),bell:r("bell")}}function Zt(e){let n,r,l,d=!1;function k({x:o,y:s,width:a}){const h=o+a,x=o+a/2,M=x+38,L=Math.min(24,a*.32);function P(g,j=0){return[[M+g*(L+j*.25),82],[M+g*(L+j*.3),106],[x+10+g*(a*.27+j*.45),121],[x+8+g*(a*.32+j*.55),145],[x+g*(a*.41+j*.7),164],[x+g*(a/2+6+j),s-27],[x+g*(a/2+6+j),s],[x+g*(a/2+6+j),s+29],[x-4+g*(a/2+12+j*1.1),266],[x-4+g*(a/2+17+j*1.15),286],[x-4+g*(a/2+20+j*1.2),310],[x+g*(a/2+26+j*1.3),329],[x+g*(a/2+28+j*1.3),350]]}function R(g,j="M"){return`${j}${g[0].join(" ")}
        C${g.slice(1).map(w=>w.join(" ")).join(" ")}`}function N(g,j){return`${R(P(g,j))}
        ${R(P(g).reverse(),"L")}Z`}function O(g,j,w){const H=P(g),q=j*3,Q=1-w,[X,ne]=[0,1].map(Z=>Q*Q*Q*H[q][Z]+3*Q*Q*w*H[q+1][Z]+3*Q*w*w*H[q+2][Z]+w*w*w*H[q+3][Z]);return[X,ne]}const A=R(P(-1)),F=R(P(1).reverse()),G=`${A}
      ${R(P(1).reverse(),"L")}
      Q${M} 76 ${M-L} 82Z`,de=[[-1,0,.68,.36],[1,0,.86,.44],[-1,1,.22,.6],[1,1,.08,.54],[-1,2,.73,.85],[1,2,.64,.8],[-1,3,.5,1.08],[1,3,.76,1.18]].map(([g,j,w,H],q)=>{const[Q,X]=O(g,j,w);return`
        <g transform="translate(${Q+g*(5+H*4)} ${X})
                      scale(${H})">
      ...
      <g clip-path="url(#canal-terrain-clip)">
        <g mask="url(#canal-horizon-mask)">
          ...
          <path d="${N(-1,10)} ${N(1,10)}"
                fill="#9caf92" opacity=".78"/>
          <path d="${N(-1,4.5)} ${N(1,4.5)}"
                fill="#d4d5b8"/>
      ...
      <rect class="obstacle-highlight" x="${o-30}" y="${s-a-12}"
            ...
            fill="none" stroke="#5b477b" stroke-width="3" stroke-dasharray="7 7"/>`}function v({x:o,y:s,width:a}){function h(M,L){return`
        <g transform="translate(${o} ${M}) scale(${a/40} ${(L-M)/100})">
        ...
        </g>`}const x=Array.from({length:5},(M,L)=>{const P=L*a/5,R=P+a*.15,N=-48-L%2*2;return`
        <path d="M${P} -4V${N+4}
                 Q${(P+R)/2} ${N-3} ${R} ${N+4}
                 V-4Z"
              fill="#f0bd83" stroke="#594565" stroke-width="1.5"
              stroke-linejoin="round"/>
        <path d="M${P+a*.06} ${N+10}V-19"
      ...
      <g class="actor-${o}" style="transform:translate(${h.x}px,${h.y}px)">
        ...
        <g transform="translate(0 32)">
          ...
          <text class="world-label" y="3">${ze(Qe.names[o])}</text>
        </g>
      </g>`}function m(o,s,a){const h=r.querySelector(o);h!==null&&h.setAttribute(s,a)}function K(o,s){const a=r.querySelector(o);a!==null&&(a.textContent=s)}function _(o,s){const a=Je(o),h=be(s.roka,"state.roka");n={...o,positions:a},l=s,d=!1,e.innerHTML=`
      ...
      </svg>`;const x=e.querySelector("svg");if(x===null)throw new TypeError("La scène n’a pas pu être rendue.");return r=x,y(s,"initial")}function B(o){let s;return o.phase==="complete"?s=n.text.success:o.phase==="crossing"?s=n.text.crossing:o.obstacleOpen?s=n.text.opened:s=n.text.closed,o.beaconOn&&(s+=" Balise allumée, avec des rayons."),o.olaWaved&&(s+=" Ola a répondu à la cloche."),s}function u(o,s){const a=r.querySelector(`.h-${o}`);if(a!==null)for(const h of["idle","walk","think","win","sulk"])a.classList.toggle(h,h===s)}function y(o,s){const a=be(o.roka,"state.roka");l=o;const h=r.querySelector(".actor-roka");h!==null&&(h.style.transform=`translate(${a.x}px,${a.y}px)`);const x=r.querySelector(".bridge-deck"),M=r.querySelector(".door-leaf");x!==null&&(x.style.transform=o.obstacleOpen?"rotate(0deg)":"rotate(-90deg)"),M!==null&&(M.style.transform=o.obstacleOpen?`matrix(1,${-84/n.positions.obstacle.width},0,1,0,0)`:"matrix(1,0,0,1,0,0)");const L=o.phase==="complete"?"win":o.phase==="crossing"?"walk":o.phase==="ready"&&o.lastCommand!==null?"think":"idle";u("roka",L),u("ola",o.phase==="complete"?"win":"idle"),m(".beacon-light","fill",o.beaconOn?"#ffb627":"#ded8e9"),m(".beacon-rays","visibility",o.beaconOn?"visible":"hidden"),m(".bell-marks","visibility",o.bellCount>0?"visible":"hidden"),m(".ola-response","visibility",o.olaWaved&&o.phase!=="complete"?"visible":"hidden"),m(".obstacle-highlight","visibility",o.obstacleOpen?"hidden":"visible"),m(".obstacle-highlight","stroke-width",d?"5":"3"),K(".obstacle-label",o.obstacleOpen?"✓ Passage libre":n.kind==="bridge"?"! Pont replié":"! Porte fermée");const P=B(o);return K("#world-description",P),{description:P,ringing:s==="rang"}}function V(){return d=!0,y(l,"highlight")}return Object.freeze({mount:_,update:y,highlightObstacle:V})}const le="C01",ae="effects-v2.1",zt={opened:500,crossed:750,completed:0,rang:1e3,lit:450,settled:0},Yt=900,Ye={title:"Bravo !",finaleHidden:!0,announcement:"",gainText:"0 XP",totalText:"0 XP",levelText:"Niveau 1",progressValue:0,progressText:"0 sur 3 XP vers le niveau 2",nextText:"Encore 3 XP pour le niveau 2",nextHidden:!1,replayHidden:!0,rewardHidden:!0,nextStepHidden:!0,closePrimary:!1,hasGain:!1,isReplay:!1};function Jt(e){const n=Object.fromEntries(e.scenes.map(i=>[i.id,i])),r=window.matchMedia("(prefers-reduced-motion: reduce)"),l=new Set;let d=null,k=null,v=!1,f=Fe(),m=Be(),K={},_=null,B=null,u=null,y=null,V=[],o=null,s=!1,a=0,h=0,x=!1,M=0,L=!0,P=!1,R=null,N=0,O=null,A=!1,F="Scène 1 sur 2",G=e.title,de="",g="",j=!1,w="Préparation de la scène…",H=null,q=!1,Q=!0,X=!0,ne="",Z="",ve="",$e=!0,ye=null,re=!1,_e="Une démo à part. Elle ne change pas la scène.",ue="",je="Le ventilateur est à l’arrêt.",pe=!1,we="Un ventilateur à l’arrêt",Me=!0,Ce=!0,W="",fe=!1,U=Ye,Pe=!1,Ve=!1,Ae=null,qe=0,Te;window.__c01_debug=window.__c01_debug??{runStarts:0};function Ne(){return u?.id==="porte"&&o===null}function et(){return u!==null&&y!==null&&J(u,y)}function Ue(){const i=et(),c=Ne(),p=u?.id??"pont",b=V[0]??null,T=(u?.commands??[]).map(C=>({id:C.id,label:C.label,code:C.code??"",icon:C.icon??"",pressed:b===C.id,executing:s&&b===C.id,disabled:s||i||c})),S=b===null?"Place une commande ici.":u?.commands.find(C=>C.id===b)?.code??"";return{ready:A,chipText:`Niveau ${m.level} · ${m.xp} XP`,progressionXp:m.xp,sceneStep:F,activityTitle:G,instruction:e.instruction,sceneTitle:de,sceneDescription:g,sceneRinging:j,sceneBusy:s,currentSceneId:p,porteUnlocked:He(m,le,"pont"),guideStep:s||i?3:V.length>0?2:1,guidePrepare:c?"Garde ta prévision":u?.id==="porte"?"Prévision gardée · Choisis ta commande":"Choisis ta commande",commands:T,paletteHidden:c,choiceInstruction:c?"D’abord, garde ta prévision. Les commandes apparaîtront ensuite.":"Choisis un seul bloc.",programContent:S,clearDisabled:s||i||V.length===0,runDisabled:!A||s||i||c,runLabel:s?"En cours…":"▶ Lancer",feedback:w,predictionHidden:Q,predictionFormHidden:q,predictionQuestion:u?.prediction?.question??"",predictionOptions:u?.prediction?.options??[],predictionSelected:H,predictionConfirmDisabled:H===null,resultHidden:X,resultTitle:ne,resultText:Z,evidenceText:ve,nextButtonHidden:$e,earned:ye,helpOpen:re,helpIntro:_e,helpDisabled:!A||s,helpFeedback:ue,demoFeedback:je,demoRunning:pe,demoLabel:we,obstacleHelpHidden:Me,directHelpHidden:Ce,storageStatus:W,eraseConfirm:fe,popup:U,popupOpen:Pe,popupFocusNextStep:Ve,focus:Ae}}function $(){Te=Ue();for(const i of l)i()}Te=Ue();function z(i){qe+=1,Ae={selector:i,seq:qe}}function he(){L=!1,W="Sauvegarde indisponible. Tu peux jouer, mais tes progrès peuvent être perdus en quittant."}function tt(){L&&(Dt(m,K)||he())}function ie(){if(!L||u===null)return;_t({version:1,sceneId:u.id,runNumber:h,statistics:f,trainingProof:_,lastCompletion:B})?W="Enregistré.":he()}function nt(i){const c=n.pont;if(c===void 0||i?.sceneId!=="pont"||i.success!==!0)return null;const p=[...f.pont.attempts].reverse().find(T=>T.success&&T.command===c.openCommand);if(p===void 0)return null;const b=Ze(c,Ge(c),[p.command]);return b.verdict.success?{sceneId:"pont",success:b.verdict.success,criteriaValidated:[...b.verdict.criteriaValidated],attempts:ee(f.pont.attempts),aidsUsed:[...f.pont.aids],verdictSource:"engine_replay_of_saved_success"}:null}function ee(i){return JSON.parse(JSON.stringify(i))}function rt(){const i=Object.fromEntries(e.scenes.map(p=>[p.id,p.commands.map(b=>b.id)])),c=Ht(i);if(c.kind==="unavailable"){he();return}if(c.kind==="corrupt"){W="La sauvegarde du jeu n’est pas lisible. La scène repart du début.";return}c.kind!=="empty"&&(f=c.value.statistics,h=c.value.runNumber,_=nt(c.value.trainingProof),B=c.value.lastCompletion,P=!0)}function it(){const i=Et();if(i.kind==="unavailable"){he();return}if(i.kind==="corrupt"){W="La progression n’est pas lisible. Le compteur repart à zéro.";return}i.kind!=="empty"&&(K=i.value.extra,m=Qt(i.value.progression))}function Se(){if(R===null)return;clearTimeout(R.timer);const{resolve:i}=R;R=null,i()}function Le(i){return r.matches||i===0?Promise.resolve():new Promise(c=>{R={timer:window.setTimeout(()=>{R=null,c()},i),resolve:c}})}function st(){const i=k;if(i===null)return Promise.resolve();const c=i.getBoundingClientRect(),p=window.innerHeight||document.documentElement.clientHeight||0,b=Math.max(0,c.top),T=Math.min(p,c.bottom);return Math.max(0,T-b)/(c.height||1)>=.6?Promise.resolve():(i.scrollIntoView({block:"center",inline:"nearest",behavior:r.matches?"instant":"smooth"}),Le(300))}function me(i,c,p=c){const{level:b,filled:T,target:S,reached:C}=Vt(c);U={...U,gainText:O!==null&&O.delta===0?"XP déjà gagnés":`+${i} XP`,totalText:`${c} XP`,levelText:`Niveau ${b}`,progressValue:At(p),progressText:C?`${S} sur ${S} XP : palier atteint, niveau ${b}`:`${T} sur ${S} XP vers le niveau ${b+1}`,nextText:C?`Palier rempli ! Niveau ${b} atteint.`:`Encore ${S-T} XP pour le niveau ${b+1}`}}function se(){cancelAnimationFrame(N),N=0,O!==null&&(me(O.delta,O.total),U={...U,rewardHidden:!O.reward},$())}function Re(i=!0){cancelAnimationFrame(N),N=0,O!==null&&(me(O.delta,O.total),U={...U,rewardHidden:!O.reward}),Pe=!1,U={...U,hasGain:!1,isReplay:!1},O=null,i&&!X&&z("#result-title"),$()}function De(){return u?.id==="pont"&&n.porte!==void 0}function ot(i){ye={xpText:i.delta>0?`+${i.delta} XP · Niveau ${m.level}`:null,reward:i.reward}}function lt(i){Re(!1),O=i;const c=De();if(U={...Ye,title:c?"Bravo !":"Aventure réussie !",finaleHidden:c,nextStepHidden:!c,closePrimary:!c,rewardHidden:!0,replayHidden:i.delta!==0,nextHidden:i.delta===0,hasGain:i.delta>0,isReplay:i.delta===0,announcement:(c?"Bravo ! ":"Bravo, tu as terminé les deux exercices ! ")+`${i.delta?`Tu gagnes ${i.delta} XP.`:"XP déjà gagnés."} Total : ${i.total} XP. Niveau ${Ut(i.total)}.`},Ve=c,ot(i),me(i.delta,i.previous),Pe=!0,$(),r.matches||i.delta===0){se();return}const p=performance.now(),b=T=>{if(O===null)return;const S=It(i.previous,i.delta,T-p);me(i.delta,S.total,S.avance),$(),S.fini?se():N=requestAnimationFrame(b)};N=requestAnimationFrame(b)}function at(i,c){try{const p=window;typeof p.WONDRA_TRACK=="function"&&p.WONDRA_TRACK(i,c)}catch{}}function ct(i){const c=qt(m,le,i);return at("c01_scene_reussie",{scene:i,xp_delta:c.delta,nouvelle_reussite:c.fresh===!0}),c.fresh&&(m=c.progression,tt()),{previous:c.previous,total:c.total,delta:c.delta,reward:c.reward!==null}}function dt(){M=0,re=!1,Me=!0,Ce=!0,ue="",je="Le ventilateur est à l’arrêt.",pe=!1,we="Un ventilateur à l’arrêt",_e=u?.id==="porte"?"Tu peux revoir la démo. À toi de trouver pour la porte !":"Une démo à part. Elle ne change pas la scène."}function ge(i){g=i.description,j=i.ringing}function oe(i,c={}){const p=n[i];if(p===void 0)return;a+=1,Se(),Re(!1),s=!1,u=p,y=Ge(p),V=[],o=null,x=!1,h+=1,F=i==="pont"?"Scène 1 sur 2":"Scène 2 sur 2",G=i==="pont"?e.title:p.title,document.title=`WONDRA — ${G}`,de=p.title,X=!0,fe=!1,ye=null,d!==null&&ge(d.mount(p,y)),Q=!(i==="porte"),q=!1,H=null,dt(),w=i==="porte"?"Garde ta prévision. Puis essaie une commande.":"Regarde le pont replié. Quelle commande peut aider Roka ?",c.persist!==!1&&ie(),c.focus===!0&&z(i==="porte"?"#prediction-title":"#palette button"),$()}function ut(){s||!De()||u===null||y===null||!J(u,y)||!He(m,le,"pont")||oe("porte",{focus:!0})}function Ie(i,c){i.push(c),i.length>200&&i.shift()}function Xe(i){return i==="porte"?f.porte:f.pont}function Oe(i){if(u===null)return;const c=Xe(u.id).aids;c.includes(i)||c.push(i),ie()}function pt(){if(u===null||y===null)return null;const i=f.porte.predictions[0]??null,c=i?.value??null,p=f.porte.attempts[0]??null,b=xe(u,y),T=[...new Set([..._?.success===!0?_.criteriaValidated:[],...b.criteriaValidated])];return o==="opening"&&T.push("prediction_correct"),{sceneId:u.id,criteriaValidated:T,training:ee(_),transfer:{sceneId:"porte",success:b.success,criteriaValidated:[...b.criteriaValidated],prediction:o,predictionCorrect:o==="opening",predictionProtocol:ae,firstRecordedPrediction:c,firstRecordedPredictionProtocol:i?.protocol??"legacy_unknown",firstRecordedCommand:p===null?null:p.command,attempts:ee(f.porte.attempts),predictions:ee(f.porte.predictions),observation:b.success?"automatic_crossing_after_one_command":null,responseHintProvided:!1},aidsUsed:{pont:[...f.pont.aids],porte:[...f.porte.aids]},transferOnFirstRecordedAttempt:i?.protocol===ae&&c==="opening"&&p!==null&&p.predictionProtocol===ae&&p.prediction==="opening"&&p.run===i.run&&p.command===u.openCommand&&p.success&&b.success&&f.porte.attempts.length===1}}function ft(i){try{const c=window.WondraProgression;if(typeof c?.onActivityCompleted=="function"){const p=c.onActivityCompleted({activity:le,evidence:ee(i)});p!==null&&typeof p?.then=="function"&&Promise.resolve(p).catch(()=>{})}}catch{}}function ht(){if(u===null||y===null)return;X=!1,Z=u.text.success;let i=null;if(u.id==="pont"){const p=xe(u,y);_={sceneId:"pont",success:p.success,criteriaValidated:[...p.criteriaValidated],attempts:ee(f.pont.attempts),aidsUsed:[...f.pont.aids],verdictSource:"engine_verdict_of_reached_state"},ne="Roka a rejoint Ola !",ve="Une commande, une action. Étape suivante : la porte.",$e=!1}else{ne="Le passage est réussi !",$e=!0;const p=u.prediction?.options.find(b=>b.id===o);ve=o==="opening"?"Tu avais prévu un chemin jusqu’à l’autre côté. Le passage est devenu libre et Roka a rejoint Ola.":`Ta prévision : « ${p?.label??""} » Tu as observé un passage devenu libre, puis Roka a rejoint Ola.`,!x&&_?.success===!0&&(x=!0,B=pt(),i=B)}const c=ct(u.id);ie(),lt(c),i!==null&&ft(i)}function mt(i){return u===null?null:{opened:u.text.opened,crossed:u.text.crossing,completed:u.text.success,rang:u.text.ring,lit:u.text.light}[i]??null}async function gt(){if(u===null||y===null||s||Ne()||J(u,y))return;const i=Ze(u,y,V);if(i.reason==="empty"){w="Choisis un bloc avant de lancer.",z("#palette button"),$();return}if(i.reason!=="executed"){w="Choisis un des trois blocs pour essayer.",$();return}u.id==="pont"&&(_=null),s=!0;const c=++a;if($(),await st(),c!==a)return;const p=window.__c01_debug;p!==void 0&&(p.runStarts+=1);const b=h,T=V[0]??"",S=u;$();try{for(const C of i.steps){if(c!==a)return;y=C.state,d!==null&&ge(d.update(C.state,C.event));const We=mt(C.event);if(We!==null&&(w=We),$(),await Le(zt[C.event]??0),c!==a)return}if(Ie(Xe(S.id).attempts,{run:b,command:T,prediction:o,predictionProtocol:S.id==="porte"?ae:null,success:i.verdict.success}),i.verdict.success){if(await Le(Yt),c!==a)return;ht()}else ie(),w=`${T==="sonner"?S.text.ring:S.text.light} Essaie une autre commande.`}finally{c===a&&(s=!1,$())}}function bt(i){if(u===null||y===null||s||Ne()||J(u,y))return;const c=u.commands.find(p=>p.id===i);c!==void 0&&(V=[c.id],w=`${c.label}. Maintenant, appuie sur « Lancer ».`,$())}function xt(){u===null||y===null||s||J(u,y)||(V=[],w="Le programme est vide. Choisis un bloc.",$())}function kt(i){H=i,$()}function vt(){s||o!==null||u?.id!=="porte"||H!==null&&(o=H,Ie(f.porte.predictions,{run:h,value:o,protocol:ae}),q=!0,Q=!0,w="Ta prévision est gardée. Choisis une commande.",ie(),z("#palette button"),$())}function $t(){s||(re=!re,re&&z("#demo-button"),$())}function yt(){s||(Oe("demo"),M=Math.max(M,1),pe=!1,$(),pe=!0,we="Le ventilateur tourne après la commande",je="tourner_ventilateur() fait tourner le ventilateur. Une commande, une action.",u?.id==="pont"&&(Me=!1),$())}function jt(){s||u?.id!=="pont"||M<1||(Oe("obstacle"),M=2,d!==null&&ge(d.highlightObstacle()),ue=u.text.highlight??"",Ce=!1,$())}function wt(){s||u?.id!=="pont"||M<2||(Oe("direct"),M=3,ue=u.text.direct??"",$())}function Mt(){fe=!0,z("#erase-yes"),$()}function Ct(){fe=!1,z("#erase-button"),$()}function Pt(){const i=Ot();L=i,f=Fe(),m=Be(),K={},_=null,B=null,h=0,oe("pont",{focus:!0,persist:!1}),W=i?"Tout est effacé. Niveau 1 · 0 XP. On repart du début.":"Le jeu repart à zéro ici. Le navigateur n’a pas pu effacer toutes les sauvegardes.",$()}function Tt(i){s||i==="porte"&&!He(m,le,"pont")||oe(i)}function Nt(){u!==null&&oe(u.id,{focus:!0})}function St(i){i.matches&&(Se(),se())}typeof r.addEventListener=="function"&&r.addEventListener("change",St);function Lt(){Se(),se()}function Rt(i){if(k=i,d=Zt(i),v){u!==null&&y!==null&&ge(d.mount(u,y)),$();return}v=!0,rt(),it(),oe("pont",{persist:!1}),A=!0,P&&W===""&&(W="Sauvegarde retrouvée. La scène repart au début ; tes progrès sont gardés."),$()}return{subscribe(i){return l.add(i),()=>{l.delete(i)}},getSnapshot:()=>Te,attach:Rt,stop:Lt,selectScene:Tt,selectCommand:bt,clearProgram:xt,run:gt,restart:Nt,goToNextExercise:ut,selectPrediction:kt,confirmPrediction:vt,toggleHelp:$t,playDemo:yt,showObstacleHelp:jt,showDirectHelp:wt,askErase:Mt,cancelErase:Ct,confirmErase:Pt,closePopup:Re,finishPopup:se}}const Kt=1,en="C01",tn="fr",nn="Le pont de Roka",rn="Aide Roka à rejoindre Ola.",sn=[{id:"pont",kind:"bridge",title:"Le canal",openCommand:"ouvrir_pont",positions:{roka:{x:218,y:215},goal:{x:516,y:215},ola:{x:618,y:212},obstacle:{x:310,y:204,width:140},beacon:{x:555,y:106},bell:{x:169,y:106}},commands:[{id:"ouvrir_pont",label:"Ouvrir le pont",icon:"bridge",code:"ouvrir_pont()"},{id:"sonner",label:"Sonner",icon:"🔔",code:"sonner()"},{id:"allumer",label:"Allumer",icon:"💡",code:"allumer()"}],text:{closed:"Obstacle : le pont est replié. Roka ne peut pas passer.",opened:"Le pont se déplie. Le passage est ouvert.",crossing:"Le pont est ouvert. Roka traverse tout seul.",success:"La commande a déplié le pont. Roka a traversé tout seul.",ring:"La cloche a sonné. Ola a répondu. Le pont reste replié.",light:"La balise est allumée. Le pont reste replié.",highlight:"Regarde le pont debout : il bloque le passage.",direct:"Choisis « Ouvrir le pont », puis « Lancer ». Le pont se déplie. Roka traverse tout seul."}},{id:"porte",kind:"door",title:"La porte du jardin",openCommand:"ouvrir_porte",positions:{roka:{x:218,y:215},goal:{x:516,y:215},ola:{x:618,y:212},obstacle:{x:364,y:204,width:40},beacon:{x:555,y:106},bell:{x:169,y:106}},commands:[{id:"allumer",label:"Allumer",icon:"💡",code:"allumer()"},{id:"ouvrir_porte",label:"Ouvrir la porte",icon:"🚪",code:"ouvrir_porte()"},{id:"sonner",label:"Sonner",icon:"🔔",code:"sonner()"}],prediction:{question:"Pour que Roka rejoigne Ola, quel résultat faut-il obtenir ?",options:[{id:"bell",label:"Ola vient chercher Roka."},{id:"beacon",label:"Roka reste au même endroit."},{id:"opening",label:"Un chemin se crée jusqu’à l’autre côté."}]},text:{closed:"Obstacle : la porte est fermée. Roka ne peut pas passer.",opened:"La porte s’ouvre. Le passage est libre.",crossing:"La porte est ouverte. Roka traverse tout seul.",success:"La commande a ouvert la porte. Roka a traversé tout seul.",ring:"La cloche a sonné. Ola a répondu. La porte reste fermée.",light:"La balise est allumée. La porte reste fermée."}}],on={version:Kt,activity:en,locale:tn,title:nn,instruction:rn,scenes:sn},ln={C01:on};class D extends Error{constructor(n){super(n),this.name="ContentError"}}function te(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function I(e,n,r){const l=e[n];if(typeof l!="string"||l.length===0)throw new D(`${r} : le champ « ${n} » doit être une chaîne non vide.`);return l}function an(e,n){if(!te(e))throw new D(`${n} : commande invalide.`);const r={id:I(e,"id",n),label:I(e,"label",n)};return typeof e.icon=="string"&&(r.icon=e.icon),typeof e.code=="string"&&(r.code=e.code),r}function cn(e,n){if(!te(e))throw new D(`${n} : exercice invalide.`);const r=I(e,"id",n),l=`${n} → « ${r} »`,d=e.commands;if(!Array.isArray(d)||d.length===0)throw new D(`${l} : au moins une commande est requise.`);const k=d.map(m=>an(m,l)),v=I(e,"openCommand",l);if(!k.some(m=>m.id===v))throw new D(`${l} : la commande d’ouverture « ${v} » ne figure pas dans les commandes.`);const f={id:r,kind:I(e,"kind",l),title:I(e,"title",l),openCommand:v,commands:k};return te(e.positions)&&(f.positions=e.positions),te(e.text)&&(f.text=e.text),te(e.prediction)&&(f.prediction=e.prediction),f}function dn(e){if(!te(e))throw new D("Niveau : la racine doit être un objet.");const n=I(e,"activity","Niveau"),r=`Niveau « ${n} »`;if(!Number.isSafeInteger(e.version)||e.version<1)throw new D(`${r} : le champ « version » doit être un entier ≥ 1.`);const l=e.scenes;if(!Array.isArray(l)||l.length===0)throw new D(`${r} : au moins un exercice est requis.`);const d=l.map(v=>cn(v,r));if(new Set(d.map(v=>v.id)).size!==d.length)throw new D(`${r} : deux exercices portent le même identifiant.`);return{version:e.version,activity:n,locale:I(e,"locale",r),title:I(e,"title",r),instruction:I(e,"instruction",r),scenes:d}}function un(e){const n=ln[e];if(n===void 0)throw new D(`Niveau inconnu : « ${e} ».`);return dn(n)}const pn=["closed","opened","crossing","success","ring","light"],fn=["highlight","direct"];function hn(e){const n=e.text??{},r={};for(const l of pn){const d=n[l];if(typeof d!="string"||d.length===0)throw new TypeError(`Texte manquant : ${e.id}.${l}`);r[l]=d}for(const l of fn){const d=n[l];typeof d=="string"&&(r[l]=d)}return r}function mn(e){if(e.kind!=="bridge"&&e.kind!=="door")throw new TypeError(`Type de scène invalide : ${e.id}`);const n={id:e.id,kind:e.kind,title:e.title,openCommand:e.openCommand,positions:Je(e),commands:e.commands,text:hn(e)};return e.prediction!==void 0?{...n,prediction:e.prediction}:n}function gn(){const e=un("C01");if(e.scenes.length!==2||!["pont","porte"].every(n=>e.scenes.filter(r=>r.id===n).length===1))throw new TypeError("Scènes invalides.");return{version:e.version,activity:e.activity,locale:e.locale,title:e.title,instruction:e.instruction,scenes:e.scenes.map(mn)}}function bn(){try{return Jt(gn())}catch{return null}}function xn(){const e=E.useRef(null);e.current??={controller:bn()};const n=e.current.controller,r=E.useCallback(m=>n===null?()=>{}:n.subscribe(m),[n]),l=E.useCallback(()=>n===null?null:n.getSnapshot(),[n]),d=E.useSyncExternalStore(r,l),k=E.useCallback(m=>{m!==null&&n!==null&&n.attach(m)},[n]);E.useEffect(()=>{window.WondraCharacters=Qe},[]),E.useEffect(()=>{const m=document.title;return()=>{document.title=m}},[]),E.useEffect(()=>{if(n===null)return;const m=()=>{n.stop()};return window.addEventListener("pagehide",m),()=>{window.removeEventListener("pagehide",m),m()}},[n]);const v=E.useRef(0),f=d?.focus??null;return E.useEffect(()=>{if(f===null||f.seq===v.current)return;v.current=f.seq;const m=document.querySelector(f.selector);m!==null&&(m.focus({preventScroll:!0}),m.scrollIntoView({block:"center",inline:"nearest",behavior:"instant"}))},[f]),{controller:n,snapshot:d,sceneRef:k}}function ce(){return t.jsxs("svg",{className:"crystal-icon",viewBox:"0 0 32 40","aria-hidden":"true",focusable:"false",children:[t.jsx("path",{d:"M16 2 27 11 29 25 16 38 3 25 5 11Z",fill:"#c9bcf0",stroke:"#594565",strokeWidth:"2",strokeLinejoin:"round"}),t.jsx("path",{d:"M16 2 10 15 16 38 22 15Z",fill:"#eee7ff"}),t.jsx("path",{d:"M3 25 10 15 16 38M29 25 22 15 16 38M5 11 10 15 22 15 27 11M16 2 22 15",fill:"none",stroke:"#8067aa",strokeWidth:"1.3",strokeLinejoin:"round"}),t.jsx("path",{d:"m12 10 3-4",fill:"none",stroke:"white",strokeWidth:"2",strokeLinecap:"round"})]})}function Ke(){return t.jsxs("svg",{className:"reward-icon",viewBox:"0 0 40 40","aria-hidden":"true",focusable:"false",children:[t.jsx("path",{d:"m24 25 10 10",fill:"none",stroke:"#594565",strokeWidth:"8",strokeLinecap:"round"}),t.jsx("path",{d:"m25 26 8 8",fill:"none",stroke:"#edc28e",strokeWidth:"4",strokeLinecap:"round"}),t.jsx("circle",{cx:"16",cy:"16",r:"12",fill:"#edc28e",stroke:"#594565",strokeWidth:"2"}),t.jsx("circle",{cx:"16",cy:"16",r:"8.5",fill:"#dceff3",stroke:"#8067aa",strokeWidth:"1.5"}),t.jsx("path",{d:"M11 16a5 5 0 0 1 5-5",fill:"none",stroke:"white",strokeWidth:"2.5",strokeLinecap:"round"})]})}function kn(){return t.jsxs("svg",{viewBox:"0 0 32 32","aria-hidden":"true",focusable:"false",children:[t.jsx("path",{d:"M2 27Q6 24 10 27T18 27T26 27T30 27",fill:"none",stroke:"#74afb9",strokeWidth:"2"}),t.jsx("path",{d:"M3 20Q16 7 29 20L29 24Q16 13 3 24Z",fill:"#edc28e",stroke:"#594565",strokeWidth:"2",strokeLinejoin:"round"}),t.jsx("path",{d:"M3 20V12M29 20V12M3 14Q16 1 29 14M10 13V8M22 13V8",fill:"none",stroke:"#8a5e46",strokeWidth:"2",strokeLinecap:"round"})]})}function vn({snapshot:e,controller:n}){return t.jsx("div",{id:"palette",className:"palette",role:"group","aria-label":"Les trois commandes",hidden:e.paletteHidden,children:e.commands.map(r=>t.jsxs("button",{type:"button",className:r.executing?"command executing":"command","data-command":r.id,"aria-pressed":r.pressed,"aria-label":r.label,disabled:r.disabled,onClick:()=>n.selectCommand(r.id),children:[t.jsx("span",{className:"icon","aria-hidden":"true",children:r.icon==="bridge"?t.jsx(kn,{}):r.icon}),t.jsxs("span",{children:[t.jsx("strong",{children:r.label}),t.jsx("code",{children:r.code})]}),t.jsx("span",{className:"check","aria-hidden":"true",children:"✓"})]},r.id))})}function $n({snapshot:e,controller:n}){return t.jsxs("section",{id:"prediction-panel",className:"prediction-panel",hidden:e.predictionHidden,"aria-labelledby":"prediction-title",children:[t.jsx("h2",{id:"prediction-title",tabIndex:-1,children:"D’abord, à ton avis…"}),t.jsxs("form",{id:"prediction-form",hidden:e.predictionFormHidden,onSubmit:r=>{r.preventDefault(),n.confirmPrediction()},children:[t.jsxs("fieldset",{children:[t.jsx("legend",{id:"prediction-question",children:e.predictionQuestion}),t.jsx("div",{id:"prediction-options",children:e.predictionOptions.map(r=>t.jsxs("label",{className:"prediction-option",children:[t.jsx("input",{type:"radio",name:"prediction",value:r.id,required:!0,checked:e.predictionSelected===r.id,onChange:()=>n.selectPrediction(r.id)}),t.jsx("span",{children:r.label})]},r.id))})]}),t.jsx("button",{id:"prediction-confirm",type:"submit",disabled:e.predictionConfirmDisabled,children:"Garder ma prévision"})]}),t.jsx("p",{id:"prediction-summary",hidden:!0})]})}function yn({snapshot:e,controller:n}){return t.jsxs("section",{className:"control-panel","aria-labelledby":"program-title",children:[t.jsx($n,{snapshot:e,controller:n}),t.jsx("h2",{id:"program-title",children:"Mon programme"}),t.jsx("p",{id:"choice-instruction",children:e.choiceInstruction}),t.jsx(vn,{snapshot:e,controller:n}),t.jsxs("div",{className:"program-slot",children:[t.jsx("span",{className:"slot-number","aria-hidden":"true",children:"1"}),t.jsx("p",{id:"program-content",children:e.programContent}),t.jsx("button",{id:"clear-button",type:"button",disabled:e.clearDisabled,"aria-label":"Vider le programme",onClick:()=>n.clearProgram(),children:"Vider"})]}),t.jsx("p",{className:"microcopy",children:"Un seul bloc. Blocs WONDRA, pas du Python."}),t.jsxs("div",{className:"actions",children:[t.jsx("button",{id:"run-button",className:"primary",type:"button",disabled:e.runDisabled,onClick:()=>{n.run()},children:e.runLabel}),t.jsx("button",{id:"restart-button",type:"button",disabled:!e.ready,onClick:()=>n.restart(),children:"↺ Recommencer"})]}),t.jsx("p",{id:"feedback",className:"feedback",role:"status","aria-live":"polite","aria-atomic":"true",children:e.feedback})]})}function jn({snapshot:e,controller:n}){const r=E.useRef(null);function l(){const d=r.current;d!==null&&(d.classList.remove("running"),d.getBoundingClientRect(),d.classList.add("running")),n.playDemo()}return t.jsxs("section",{className:"help-section","aria-labelledby":"help-title",children:[t.jsxs("div",{className:"section-heading",children:[t.jsx("h2",{id:"help-title",children:"Un coup de main ?"}),t.jsx("button",{id:"help-button",type:"button","aria-expanded":e.helpOpen,"aria-controls":"help-panel",disabled:e.helpDisabled,onClick:()=>n.toggleHelp(),children:e.helpOpen?"Fermer l’aide":"Ouvrir l’aide"})]}),t.jsxs("div",{id:"help-panel",className:"help-panel",hidden:!e.helpOpen,children:[t.jsx("p",{id:"help-intro",children:e.helpIntro}),t.jsxs("div",{className:"demo",children:[t.jsxs("svg",{id:"demo-fan",ref:r,className:e.demoRunning?"running":"",viewBox:"0 0 120 110",width:"120",height:"110",role:"img","aria-label":e.demoLabel,children:[t.jsx("path",{d:"M60 62V95M38 99H82",fill:"none",stroke:"#221b4e",strokeWidth:"7",strokeLinecap:"round"}),t.jsx("circle",{cx:"60",cy:"44",r:"36",fill:"#f0ecfa",stroke:"#221b4e",strokeWidth:"4"}),t.jsx("g",{className:"fan-blades",children:t.jsx("path",{d:`M60 44C39 40 38 15 52 16C65 17 65 31 60 44
                       M60 44C73 26 96 34 88 47C81 57 68 51 60 44
                       M60 44C68 65 50 81 42 69C35 58 47 48 60 44`,fill:"#7ba7f0",stroke:"#221b4e",strokeWidth:"2"})}),t.jsx("circle",{cx:"60",cy:"44",r:"6",fill:"#221b4e"})]}),t.jsxs("div",{children:[t.jsx("p",{children:t.jsx("code",{children:"tourner_ventilateur()"})}),t.jsx("button",{id:"demo-button",type:"button",disabled:e.helpDisabled,onClick:l,children:"▶ Jouer la démo"}),t.jsx("p",{id:"demo-feedback",role:"status",children:e.demoFeedback})]})]}),t.jsxs("div",{className:"actions",children:[t.jsx("button",{id:"obstacle-help-button",type:"button",hidden:e.obstacleHelpHidden,disabled:e.helpDisabled,onClick:()=>n.showObstacleHelp(),children:"Voir l’obstacle"}),t.jsx("button",{id:"direct-help-button",type:"button",hidden:e.directHelpHidden,disabled:e.helpDisabled,onClick:()=>n.showDirectHelp(),children:"Explique-moi"})]}),t.jsx("p",{id:"help-feedback",role:"status",children:e.helpFeedback})]})]})}function wn({snapshot:e,controller:n,onExit:r}){return t.jsxs("footer",{className:"page-footer",children:[t.jsx("p",{children:"Ton Carnet garde tes XP et tes outils. Rien ne se dépense."}),t.jsx("p",{id:"storage-status",role:"status",children:e.storageStatus}),t.jsx("button",{id:"erase-button",type:"button",disabled:!e.ready,onClick:()=>n.askErase(),children:"Effacer la sauvegarde"}),t.jsxs("div",{id:"erase-confirmation",className:"erase-confirmation",hidden:!e.eraseConfirm,children:[t.jsx("p",{children:"Effacer les essais, les XP et les cristaux ? Cette action ne peut pas être annulée."}),t.jsx("button",{id:"erase-yes",type:"button",onClick:()=>n.confirmErase(),children:"Oui, tout effacer"}),t.jsx("button",{id:"erase-no",type:"button",onClick:()=>n.cancelErase(),children:"Non, garder"})]}),r===void 0?null:t.jsx("button",{id:"exit-button",type:"button",onClick:r,children:"← Revenir à l’accueil"})]})}function Mn({snapshot:e}){const{earned:n}=e;return n===null?t.jsx("p",{id:"earned-summary",className:"earned-summary"}):t.jsxs("p",{id:"earned-summary",className:"earned-summary",children:[n.xpText===null?"Bravo ! Les XP de cette scène sont déjà gagnés.":t.jsxs("span",{className:"earned-item",children:[t.jsx(ce,{}),t.jsx("span",{children:n.xpText})]}),n.reward?t.jsxs("span",{className:"earned-item",children:[t.jsx(Ke,{}),t.jsx("span",{children:"Tu as gagné : la Loupe du créateur"})]}):null]})}function Cn({snapshot:e,controller:n}){return t.jsxs("section",{id:"result-panel",className:"result-panel",hidden:e.resultHidden,"aria-labelledby":"result-title",children:[t.jsx("p",{className:"eyebrow",children:"✓ Passage réussi"}),t.jsx("h2",{id:"result-title",tabIndex:-1,children:e.resultTitle}),t.jsx("p",{id:"result-text",children:e.resultText}),t.jsx("p",{id:"evidence-text",children:e.evidenceText}),t.jsx(Mn,{snapshot:e}),t.jsx("button",{id:"next-button",className:"primary",type:"button",hidden:e.nextButtonHidden,onClick:()=>n.goToNextExercise(),children:"Étape suivante : la porte →"})]})}function Pn({snapshot:e,controller:n}){const{currentSceneId:r,porteUnlocked:l}=e;return t.jsxs("div",{id:"exercise-switch",className:"exercise-switch",role:"group","aria-label":"Choisir l’exercice",children:[t.jsx("button",{id:"ex-pont",type:"button",className:r==="pont"?"active":"","aria-current":r==="pont"?"true":void 0,onClick:()=>n.selectScene("pont"),children:"1 · Le pont"}),t.jsx("button",{id:"ex-porte",type:"button",className:r==="porte"?"active":"","aria-current":r==="porte"?"true":void 0,disabled:!l,title:l?"":"Réussis d'abord le pont.","aria-label":l?void 0:"Réussis d'abord le pont.",onClick:()=>n.selectScene("porte"),children:"2 · La porte"})]})}function Tn({snapshot:e,controller:n,sceneRef:r}){return t.jsxs("section",{className:"scene-panel","aria-labelledby":"scene-title",children:[t.jsxs("div",{className:"scene-heading",children:[t.jsx("h2",{id:"scene-title",children:e.sceneTitle}),t.jsx("span",{className:"scene-tag",children:"Une commande → une action"})]}),t.jsx(Pn,{snapshot:e,controller:n}),t.jsx("div",{id:"scene",className:e.sceneRinging?"scene ringing":"scene","aria-busy":e.sceneBusy,ref:r}),t.jsx("p",{id:"scene-description",className:"scene-description",children:e.sceneDescription})]})}function Nn({snapshot:e,controller:n}){const r=E.useRef(null),{popup:l,popupOpen:d,popupFocusNextStep:k}=e;E.useEffect(()=>{const f=r.current;f!==null&&(d&&!f.open?(f.showModal(),document.getElementById(k?"xp-next-step":"xp-close")?.focus()):!d&&f.open&&f.close())},[d,k]);const v=[l.hasGain?"has-gain":"",l.isReplay?"is-replay":""].filter(f=>f!=="").join(" ");return t.jsxs("dialog",{id:"xp-popup",ref:r,className:v,"aria-labelledby":"xp-title","aria-describedby":"xp-announcement",onCancel:f=>{f.preventDefault(),n.closePopup()},children:[t.jsx("div",{className:"popup-emblem","aria-hidden":"true",children:"✦"}),t.jsx("h2",{id:"xp-title",children:l.title}),t.jsx("p",{id:"xp-finale",className:"popup-finale",hidden:l.finaleHidden,children:"Bravo, tu as terminé les deux exercices !"}),t.jsx("p",{id:"xp-announcement",className:"sr-only",children:l.announcement}),t.jsxs("div",{className:"xp-numbers","aria-hidden":"true",children:[t.jsxs("p",{id:"xp-gain","data-etat":l.hasGain?"gain":"repos",children:[t.jsx(ce,{}),t.jsx("span",{id:"xp-gain-text",children:l.gainText})]}),t.jsxs("p",{className:"xp-total-line",children:["Total :",t.jsxs("strong",{id:"xp-total",children:[t.jsx(ce,{}),t.jsx("span",{id:"xp-total-text",children:l.totalText})]})]}),t.jsx("p",{id:"popup-level",children:l.levelText})]}),t.jsx("label",{className:"sr-only",htmlFor:"xp-progress",children:"Progression du palier de niveau"}),t.jsxs("div",{className:"xp-progress-row",children:[t.jsx(ce,{}),t.jsx("progress",{id:"xp-progress",max:Xt,value:l.progressValue,"aria-valuetext":l.progressText})]}),t.jsx("p",{id:"xp-next",className:"[font-variant-numeric:tabular-nums]",hidden:l.nextHidden,children:l.nextText}),t.jsx("p",{id:"xp-replay",hidden:l.replayHidden,children:"Ces XP sont déjà dans ton Carnet."}),t.jsxs("p",{id:"reward-toast",className:"reward-toast",role:"status","aria-atomic":"true",hidden:l.rewardHidden,children:[t.jsx(Ke,{}),t.jsx("span",{children:"Tu as gagné : la Loupe du créateur"})]}),t.jsxs("div",{className:"popup-actions",children:[t.jsx("button",{id:"xp-next-step",className:"primary",type:"button",hidden:l.nextStepHidden,onClick:()=>n.goToNextExercise(),children:"Étape suivante : la porte →"}),t.jsx("button",{id:"xp-close",type:"button",className:l.closePrimary?"primary":"",onClick:()=>n.closePopup(),children:"Voir mon résultat"})]})]})}function Ee({step:e,current:n,children:r}){return t.jsxs("li",{"data-guide-step":e,"aria-current":e===n?"step":void 0,children:[t.jsx("b",{children:e})," ",r]})}function Rn({onExit:e}){const{controller:n,snapshot:r,sceneRef:l}=xn(),d=Wt(r!==null&&r.ready?r.progressionXp:null);return n===null||r===null?t.jsx("main",{children:t.jsx("p",{id:"feedback",className:"feedback",role:"status","aria-live":"polite","aria-atomic":"true",children:"La scène ne peut pas être chargée. Ses données doivent être vérifiées."})}):t.jsxs("div",{className:"c01-page",children:[t.jsxs("header",{className:"page-header",children:[t.jsxs("p",{className:"brand",children:["WONDRA",t.jsx("span",{children:"CREATE · Mon premier programme"})]}),t.jsxs("p",{id:"level-chip",className:"level-chip","data-en-montee":d.enMontee?"true":"false",children:[t.jsx(ce,{}),t.jsx("span",{id:"level-chip-text",children:d.text})]})]}),t.jsxs("main",{children:[t.jsxs("header",{className:"activity-header",children:[t.jsx("p",{id:"scene-step",className:"eyebrow",children:r.sceneStep}),t.jsx("h1",{id:"activity-title",children:r.activityTitle}),t.jsx("p",{id:"instruction",className:"instruction",children:r.instruction}),t.jsx("p",{className:"mission-note",children:"Une commande agit. Si le passage est libre, Roka traverse tout seul."})]}),t.jsxs("ol",{className:"guide","aria-label":"Les trois temps de ton programme",children:[t.jsx(Ee,{step:1,current:r.guideStep===1?1:0,children:t.jsx("span",{id:"guide-prepare",children:r.guidePrepare})}),t.jsx(Ee,{step:2,current:r.guideStep,children:"Lance"}),t.jsx(Ee,{step:3,current:r.guideStep,children:"Regarde ce qui se passe"})]}),t.jsxs("div",{className:"game-layout",children:[t.jsx(Tn,{snapshot:r,controller:n,sceneRef:l}),t.jsx(Cn,{snapshot:r,controller:n}),t.jsx(yn,{snapshot:r,controller:n})]}),t.jsx(jn,{snapshot:r,controller:n}),t.jsx(wn,{snapshot:r,controller:n,onExit:e})]}),t.jsx(Nn,{snapshot:r,controller:n})]})}export{Rn as default};
